...
class SuperHybridStrategy:
    def __init__(self):
        ...
        # Untuk penanganan fallback di dalam gua
    ...
    def decide(self, state: GameState) -> Dict:
        ...
        if state.in_cave:
            ...
            # 2. Jika tidak ada, coba interact dengan semua interactables (fallback)
            for obj in state.get_interactables():
                if not isinstance(obj, dict):
                    continue
                obj_type = str(obj.get("type", obj.get("kind", ""))).lower()
                # Cari yang berbau "cave" atau "exit"
            ...
            # 3. Jika masih tidak ada, dan sudah beberapa turn, coba interaksi dengan objek pertama
            ...
            # 4. Terakhir, wait agar tidak kena penolakan move
    ...
    # --- Metode pembantu dengan pengecekan in_cave ---
